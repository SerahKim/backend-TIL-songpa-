...
public class Application1 {
    public static void main(String[] args) {
        ...
        다형성은 객체 지향 프로그래밍의 3대 특징 (캡슐화, 상속, 다형성) 중 하나이며,
...
//        a2.bite
        ...
        /*
        타입 형변환을 잘못하는 경우
        컴파일시에는 문제가 되지 않지만 런타임시 Exception을 발생한다.
        */
