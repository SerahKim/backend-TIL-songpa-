    ...
    public static void main(String[] args) {
        ...
        * 형변환 종류와 규칙
        ...
        - 작은 자료형에서 큰 자료형으로 자동 형변환 된다.
            ...
            - 논리형은 형변환 규칙에서 제외된다.
         2. 강제 형변환(명시적 형변환) : 형변환(cast) 연산를 이용하여 강제적으로 수행하는 형변환
         - 자동 형변환이 적용되지 않는 경우 강제 형변환이 필요하다.
        */
...
//        int result = num1 + num2; // 자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int형 변수에 값을 담을 수 없다.
        long result1 = num1 + num2; // 큰 자료형에 맞춰 데이터 손실이 없도록 long으로 데이터 타입 지정
        ...
        System.out.println("result3 = " + result3); // 정수와 실수의 연산에서는 값이 실수로 나온다.

        // 1-1-4. 문자형은 int형으로 자동 형변환된다.
        char ch1 = 'a';
        int charNumber = ch1;

        System.out.println("charNumber = " + charNumber);

        // 1-1-5. 논리형은 형변환 규칙에서 제외된다. -> 어느 자료형이든 boolean을 형변환해서 담을 수 없다.
        boolean isTrue = true;
//        byte b = isTrue;
//        short s = isTrue;
    }
