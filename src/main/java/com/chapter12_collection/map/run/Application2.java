package com.chapter12_collection.map.run;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        */
        ...
        prop.setProperty("driver", "oracle.jdbc.driver.OrcaleDrive");
        ...
        try {
            ...
            prop.storeToXML(new FileOutputStream("driver.xml"), "jbdc driver");
        } catch (IOException e) {
        ...
        try {
            ...
            // getProperty()를 통해 해당 키의 값을 읽어올 수 있다.
