...
public class Application1 {
    public static void main(String[] args) {
        ...
        수학 : f(x, y) = x * y -> 람다식 : (x, y) -> x * y;

        람다식을 사용하는 장점은 단순함이다.
        람다식을 활용하면 컬렉션에 연계하여 데이터를 쉽게 조작할 수 있으며,
        불필요한 반복되는 코드도 제거할 수 있다.
        ...
        람다식에서 매개변수의 타입은 추론이 가능하기 떄문에 명시적으로 작서하지 않아도 된다.
        ...
        */
        ...
        2. 익명클래스를 활용하여 메소드를 재정의 후 사용하는 방법
        3. 람다식을 활용하는 방법
        */
