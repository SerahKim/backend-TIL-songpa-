...
public class Application {
    public static void main(String[] args) {
        /*
        super와 super()
        - super : 자식 클래스를 이용해서 객체를 생성할 때 부모 생성자를 호출하여 부모클래스와 인스턴스도 함께 생성하게 된다.
        ...
        */
        ...
        Product product2 = new Product("S-01234", "삼성", "갤럭시Z폴드", 239000, new java.util.Date());
        ...
        Computer computer3 = new Computer("S-01234", "삼성", "갤럭시Z폴드", 239000, new java.util.Date(), "퀄컴 스냅드래곤", 512, 12, "안드로이드");
