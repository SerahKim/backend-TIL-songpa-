package com.chapter13_exception.exception;

// 예외를 사용하는 쪽에서도 Exception을 위임해줘야 한다. (throws Exception)
public class Application1 {
    public static void main(String[] args) throws Exception {
        ...
        코드를 컴파일하려고 할 때 컴파일 에러를 발생시킨다. 엄밀히 말하면 문법상의 오류이다.
        혹은 자바 문법에 맞게 작성하여 컴파일에 문제가 없더라도, 실행되면서 예상치 못하게 오류가 발생할 수 있다.
        컴퓨터 프로그램이 동작하는 도중에 예상치 못한 사태가 발생하여 실행중인 프로그램이 영향을 받는 것을
        ...
        개발자는 이러한 예외에 대해 예외처리를 통해 예외 상호아을 적절히 처리하여 코드의 흐름을 컨트롤 할 수 있다.
        */
        ...
        */
        ...
        /* 1. throws로 위임 */
        et.checkEnoughMoney(10000, 50000);// 강제로 예외 발생
