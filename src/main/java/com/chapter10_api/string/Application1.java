    ...
    public static void main(String[] args) {
        ...
        */
        ...
        compareTo() : 인자로 전달된 문자열과 사전 순으로 비교를 하여
                      두 문자열이 같으면 0을 반환, 인자로 전달된 문자열보다 작으면 음수를, 크면 양수를 반환한다.
        ...
        */
        ...
        /*
        concat() : 문자열에 인자로 전달된 문자열 합치기를 통해서 새로운 문자열을 반환한다.
                   원본 문자열에는 영향을 주지 않는다.
        */
        ...
        */
        ...
        System.out.println(javaOracle.substring(3, 6)); // aor, 시작 인덱스부터 마지막 인덱스 전까지의 문자열을 반환
        System.out.println(javaOracle.substring(3)); // aoracle, 시작 인덱스부터 문자열 끝까지
