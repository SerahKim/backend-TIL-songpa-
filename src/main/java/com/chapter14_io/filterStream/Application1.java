...
public class Application1 {
    public static void main(String[] args) {
        ...
        */
        ...
        try {
            bw = new BufferedWriter(new FileWriter("src/main/java/com/chapter14_io/filterStream/testBuffered.txt"));
        ...
        try {
            br = new BufferedReader(new FileReader("src/main/java/com/chapter14_io/filterStream/testBuffered.txt"));
