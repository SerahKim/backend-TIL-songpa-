package com.chapter06_class_object.constructor;

public class Application {
    public static void main(String[] args) {
        /* 생성자 함수의 선언 및 호출 */
        /*
        지금까지 우리가 객체를 생성했던 코드를 다시 한 번 살펴보자.
        클래스명 레퍼런스_변수명 = new 클래스명(); 이렇게 객체를 생성했다.
        하지만 new 뒤에 클래스명은 사실 생성자라 불리는 메소드를 호출하는 구문이다.
        정확히 말하자면 클래스명 레퍼런스_변수명 = new 생성자();라고 표현한다.
        */
        ...
        기본 생성자를 이용해 인스턴스를 생성하게 되면 자바에서는 자료형별 초기값을 이용해 필드를 초기화한다.
        필드의 초기값을 사용자가 원하는대로 설정하고 싶을 경우 생성자의 호출 시 인자로 값을 전달하여 호출할 수 있다.
        이러한 인자를 받아 필드를 초기화할 목적의 생성자를 매개변수 있는 생성자라고 한다.
        ...
        */
        ...
        /* 1. 기본 생성자 호출하여 인스턴스 생성 후 필드값 출력 */
        User user1 = new User();
